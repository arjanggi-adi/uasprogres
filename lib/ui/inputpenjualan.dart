  ...
  Future<http.Response> adddata(index) async {
    ...
    if (index == null) {
      ...
      final http.Response response = await http
        ...
        'jenis_sepeda': jenis_sepedaController.text,
...
//maka controller diisi dengan nilai dari variabel list sesuai dengan index dan name variabel
      ...
      jenis_sepedaController =
          TextEditingController(text: widget.list['jenis_sepeda']);
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              keyboardType: TextInputType.number,
              decoration: InputDecoration(
                hintText: "masukkan harga pesanan anda",
                labelText: "Harga",
                border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(20.0)),
              ),
